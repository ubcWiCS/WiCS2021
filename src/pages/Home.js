...
export default function Home() {
  ...
  return (
    <main className="flex flex-col w-full">
      {/* Banner */}
      {/* Banner */}
      <section   style={{ height: "calc(100vh - 0px)" }} className="relative w-full bg-gradient-to-b from-wicsPink to-wicsIndigo h-screen">
      ...
      <div className="flex flex-col items-center text-center bg-[#fdfdfb] py-10 my-10 px-4">
        ...
        <p className="text-gray-700 mb-6 max-w-2xl">
          Sign up for our newsletter to get the latest resources, tips, and
          upcoming events.
        </p>
        <NewsletterSignup />
      </div>
